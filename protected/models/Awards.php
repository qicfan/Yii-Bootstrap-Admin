...
class Awards extends ActiveRecord
{
	 ...
	 * @return Awa the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('id, cardbatch, count, type', 'required'),
			array('id, count, type', 'numerical', 'integerOnly'=>true),
			array('cardbatch', 'length', 'max'=>50),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, cardbatch, count, type', 'safe', 'on'=>'search'),
		);
	}
